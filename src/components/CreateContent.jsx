...
const CreateContent = ({ user, hasChannel, channelId, onNavigate }) => {
    ...
    const handlePublishPost = async (e) => {
        ...
        try {
            let imageUrl = null;
            if (postImage) {
                imageUrl = await storageService.uploadFile(postImage, 'suhba/images');
            }
    ...
    const handlePublishVideo = async (e) => {
        ...
        try {
            const videoUrl = await storageService.uploadFile(videoFile, 'suhba/videos');
    ...
    const handlePublishShort = async (e) => {
        ...
        try {
            const videoUrl = await storageService.uploadFile(shortFile, 'suhba/shorts');
